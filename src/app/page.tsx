...
const assetMap = [
  ...
  {"id":"testimonial-2","url":"https://images.pexels.com/photos/302894/pexels-photo-302894.jpeg?auto=compress&cs=tinysrgb&h=650&w=940","alt":"Close-up of espresso pouring from a shiny coffee machine into a white cup, perfect for lovers of caffeine and barista art."},
  {"id":"testimonial-3","url":"https://images.pexels.com/photos/4063795/pexels-photo-4063795.jpeg?auto=compress&cs=tinysrgb&h=650&w=940","alt":"A woman in a wheelchair wearing a red blazer sits at a café counter, enjoying leisure time indoors."},
  {"id":"testimonial-4","url":"https://images.pexels.com/photos/34321386/pexels-photo-34321386.jpeg?auto=compress&cs=tinysrgb&h=650&w=940","alt":"coffee lover - Photo by Novkov Visuals"},
  {"id":"team-barista-img","url":"https://images.pexels.com/photos/373639/pexels-photo-373639.jpeg?auto=compress&cs=tinysrgb&h=650&w=940","alt":"A barista holds a coffee cup with beautiful latte art in a cozy café setting."},
  {"id":"team-manager-img","url":"https://images.pexels.com/photos/4347119/pexels-photo-4347119.jpeg?auto=compress&cs=tinysrgb&h=650&w=940","alt":"Mature man with laptop working in a coffee shop, surrounded by a busy environment."}
];
            ...
            members={[
              {
                ...
                name: "Sophie P.",
                role: "Barista",
                imageSrc: assetMap.find(a => a.id === 'team-barista-img')?.url ?? '/public/images/placeholder.webp'
              },
              {
                id: "2",
                name: "Amélie Laurent",
                role: "Manager",
                imageSrc: assetMap.find(a => a.id === 'team-manager-img')?.url ?? '/public/images/placeholder.webp'
              }
            ]}
            title="Meet Our Team"
